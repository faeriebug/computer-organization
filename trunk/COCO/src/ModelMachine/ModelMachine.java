...
public class ModelMachine {
	...
	public ModelMachine() {
		...
		IB = new innerBus(12);IB.name=GS.n_IB;// 0入线，1~11出线
		DB = new innerBus(5);DB.name=GS.n_DB;// 0MDR入线，1MS入线，2MDR出线，3IR出线，4MS出线
		AB = new innerBus(2);AB.name=GS.n_AB;// 0入线，1出线
